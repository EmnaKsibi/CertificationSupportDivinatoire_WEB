	...
	<div class="sidebar collapse light-grey card-2 " id="mySidenav">
		 <div class="bar-block">
		 	<div class="container">
				...
				<a class="bar-item button active" href="${pageContext.request.contextPath}/TarotMarseilleNiveau1/Papesse">Papesse</a>
	...
	<div class="main" id="main" >
	 	<div class="col l12 m12 " >
	        <div class="tutorialTitle">
	            <strong>Papesse</strong> <br>
	            <em>Tarot de Marseille Niveau 1</em> 	
	        </div>
			<div class="clear nextprev ">	
       		   <br><br>
			   <a class="right btn blue" href="${pageContext.request.contextPath}/TarotMarseilleNiveau1/Imperatrice">Suivant »</a>
			   	<a class="left btn blue" href="${pageContext.request.contextPath}/TarotMarseilleNiveau1/Bateleur">« Précédant</a>

			</div>
			<hr>
			<h2>Papesse Introduction</h2>
			<p class="intro">
			...
			<div>
				...
				<audio src="${pageContext.request.contextPath}/audio/TarotMarseilleNiveau1Papesse.mp3" controls controlsList="nodownload" ></audio>
			</div>
			<hr>
			<div class="row margin-bottom">
				<div class="col l6 ">
					...
					<a id="startQuizButton" href="${pageContext.request.contextPath}/takeExam?niveau=TarotMarseilleNiveau1&&test=Papesse&&previousExamToValidate=Bateleur" class="button dark-grey">Répondez au quiz maintenant</a>		  				 		
				</div>
			 	<div class="col l6" style="padding:3%">
				   <img src="${pageContext.request.contextPath}/images/TarotMarseilleNiveau1Papesse.jpg" style="max-width:90%;margin:auto;display:block">	   
			 	</div> 
			</div>
			<br>
			<div class="clear nextprev">
