	...
	<div class="sidebar collapse light-grey card-2 " id="mySidenav">
		 <div class="bar-block">
		 	<div class="container">
				...
				<a class="bar-item button active" href="${pageContext.request.contextPath}/TarotMarseilleNiveau1/Temperance">Tempérance</a>
	...
	<div class="main" id="main" >
	 	<div class="col l12 m12 " >
	        <div class="tutorialTitle">
	            <strong>Tempérance</strong> <br>
	            <em>Tarot de Marseille Niveau 1</em> 	
	        </div>
			<div class="clear nextprev ">	
       		   <br><br>
			   <a class="right btn blue" href="${pageContext.request.contextPath}/TarotMarseilleNiveau1/Diable">Suivant »</a>
			   	<a class="left btn blue" href="${pageContext.request.contextPath}/TarotMarseilleNiveau1/ArcaneSansNom">« Précédant</a>

			</div>
			<hr>
			<h2>Temperance Introduction</h2>
			<p class="intro">
			...
			<hr>
			<h2>Temperance Audio</h2>
			<div>
				<p>Écoutez le cours suivant pour renforcer vos idées.</p>
				<audio src="${pageContext.request.contextPath}/audio/TarotMarseilleNiveau1Temperance.mp3" controls controlsList="nodownload" ></audio>
			</div>
			<hr>
			<div class="row margin-bottom">
				<div class="col l6 ">
				 	<h2>Temperance Quiz</h2>
				 	 <ul>
					...
					<a id="startQuizButton" href="${pageContext.request.contextPath}/takeExam?niveau=TarotMarseilleNiveau1&&test=Temperance&&previousExamToValidate=ArcaneSansNom" class="button dark-grey">Répondez au quiz maintenant</a>		  				 		
				</div>
			 	<div class="col l6" style="padding:3%">
				   <img src="${pageContext.request.contextPath}/images/TarotMarseilleNiveau1Temperance.jpg" style="max-width:90%;margin:auto;display:block">	   
			 	</div> 
			</div>
			<br>
			<div class="clear nextprev">
